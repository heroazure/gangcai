<template>
  <div class="hlj-container-wrap">
    ...
    <div class="form-pleft">
      ...
      <mt-field label="厚度D(mm)" placeholder="请输入腰厚" type="number" v-model="thickness"></mt-field>
    ...
    computed: {
      ...
      result(){
        ...
        try {
          ...
          return (((thickness*width*length*this.materialValue*2)+(thickness*height*length*this.materialValue))/1000000).toFixed(6)
        } catch (e) {
          return ''
        }
      }
